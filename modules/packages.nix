{ config, pkgs, ... }:
{
  environment.systemPackages = with pkgs; [
    ...
    google-chrome inputs.zen-browser.packages.${pkgs.system}.default
    ...
    code-cursor vim neovim wget fzf gnumake unzip shellcheck
